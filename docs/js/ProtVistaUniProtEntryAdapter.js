var ProtVistaUniProtEntryAdapter = (function () {
'use strict';
...
var BasicHelper = function () {
    function BasicHelper() {
        classCallCheck(this, BasicHelper);
    }

    createClass(BasicHelper, null, [{
        key: 'renameProperties',
        value: function renameProperties(features) {
            forEach$1(features, function (ft) {
                if (ft.begin) {
                    ft.start = ft.begin;
                    delete ft.begin;
                }
        ...
        key: 'getEvidenceFromCodes',
        value: function getEvidenceFromCodes(evidenceList) {
            if (!evidenceList) return;
            var html = '';
            evidenceList.map(function (ev) {
                var ecoMatch = ecoMap.find(function (eco) {
                    return eco.name === ev.code;
                });
                if (!ecoMatch) return;
        ...
        key: 'formatTooltip',
        value: function formatTooltip(feature) {
            var evidenceHTML = BasicHelper.getEvidenceFromCodes(feature.evidences);
...
var ProtVistaUniProtEntryAdapter$1 = function (_HTMLElement) {
    inherits(ProtVistaUniProtEntryAdapter, _HTMLElement);

    function ProtVistaUniProtEntryAdapter() {
        classCallCheck(this, ProtVistaUniProtEntryAdapter);

        var _this = possibleConstructorReturn(this, (ProtVistaUniProtEntryAdapter.__proto__ || Object.getPrototypeOf(ProtVistaUniProtEntryAdapter)).call(this));

        _this._adaptedData = [];
        _this._basicHelper = BasicHelper;
        return _this;
    }

    createClass(ProtVistaUniProtEntryAdapter, [{
        ...
        value: function filterData() {
            ...
            if (this._filters.length > 0) {
                this._adaptedData = this._adaptedData.filter(function (d) {
                    return _this2._filters.includes(d.type);
                });
            }
        }
    }, {
        ...
        key: '_removeChildrenInList',
        value: function _removeChildrenInList(elem, list, start, end) {
            ...
            this.addEventListener('load', function (e) {
                if (e.target !== _this3) {
                    ...
                    try {
                        ...
                        _this3.parseEntry(e.detail.payload);
                        _this3.filterData();
                        _this3.dispatchEvent(new CustomEvent('load', {
                            detail: {
                                payload: _this3._adaptedData
                            },
                            bubbles: true,
                            cancelable: true
                        }));
                    } catch (error) {
                        _this3.dispatchEvent(new CustomEvent('error', {
                            detail: error,
                            bubbles: true,
                            cancelable: true
                        }));
...
if (window.customElements) {
    customElements.define('protvista-uniprot-entry-adapter', ProtVistaUniProtEntryAdapter$1);
}

return ProtVistaUniProtEntryAdapter$1;

}());
//# sourceMappingURL=ProtVistaUniProtEntryAdapter.js.map
