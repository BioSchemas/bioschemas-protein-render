var BioschemasProteinRender = (function () {
'use strict';
...
var BioschemasProteinRender$1 = function (_HTMLElement) {
    inherits(BioschemasProteinRender, _HTMLElement);

    function BioschemasProteinRender() {
        classCallCheck(this, BioschemasProteinRender);

        var _this = possibleConstructorReturn(this, (BioschemasProteinRender.__proto__ || Object.getPrototypeOf(BioschemasProteinRender)).call(this));

        _this._proteinSchema = {};
        _this._structureSchema = {};
        _this._uniprotAdapterID = 'uniprot-adapter';
        _this._pdbeAdapterID = 'pdbe-adapter';
        _this._pdbeID = '';
        return _this;
    }

    createClass(BioschemasProteinRender, [{
        ...
        key: '_renderSchema',
        value: function _renderSchema(schema, title, element) {
        ...
        key: '_createPDBeAdapter',
        value: function _createPDBeAdapter(entry) {
            var adapterPDB = document.createElement('bioschemas-pdbe-adapter');
            adapterPDB.id = this._pdbeAdapterID;
            var loaderPDB = document.createElement('data-loader');
            var sourcePDB = document.createElement('source');
        ...
        key: '_getFirstPDBeEntry',
        value: function _getFirstPDBeEntry() {
            var pdbe = filter$1(this._proteinSchema.seeAlso, function (reference) {
            ...
            this.addEventListener('load', function (e) {
                if (e.target !== _this2) {
                    ...
                    try {
                        ...
                        if (e.target.id === _this2._uniprotAdapterID) {
                            _this2._proteinSchema = e.detail.payload;
                            _this2._renderSchema(_this2._proteinSchema, 'UniProt entry markup: ' + _this2._accession, 'h1');
                            _this2._createPDBeAdapter(_this2._getFirstPDBeEntry());
                        } else if (e.target.id === _this2._pdbeAdapterID) {
                            _this2._structureSchema = e.detail.payload;
                            _this2._renderSchema(_this2._structureSchema, 'First PDBe entry markup: ' + _this2._pdbeID, 'h2');
                        }
                    } catch (error) {
    ...
    return BioschemasProteinRender;
}(HTMLElement);

if (window.customElements) {
    customElements.define('bioschemas-protein-render', BioschemasProteinRender$1);
}

return BioschemasProteinRender$1;

}());
//# sourceMappingURL=BioschemasProteinRender.js.map
